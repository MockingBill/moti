...
exports.array2map = function (array, key, value) {
    var map = {};
    if(array) {
...
exports.returnError = function(msg, code) {
    var err = new Error(msg);
    err.ecode = code;
    return err;
};

exports.returnMsg = function(success, code, msg, data, err){
        if(data != null) {//console.log(success+'/'+msg);
            if(success) {
...
exports.returnEclMsg = function(res, success, ecl, module_code, biz_code, data){
    //console.log('module_code:', ecl['app_biz_map'][module_code]['app_biz_code_map'][biz_code]);
    // 检查ecl定义信息
    if(!ecl || !ecl['app_biz_map'] || !ecl['app_biz_map'][module_code]
        || !ecl['app_biz_map'][module_code]['app_biz_code_map']
        || !ecl['app_biz_map'][module_code]['app_biz_code_map'][biz_code]
        || !ecl['app_biz_map'][module_code]['app_biz_code_map'][biz_code]['sdesp']
        || !ecl['app_biz_map'][module_code]['app_biz_code_map'][biz_code]['desp']) {

        this.respMsg(res, false, 5000, 'ecl模块['+ module_code+']定义不完整', null, null);
    }
    else {


        res.set('app_typeid',ecl.app_id);
        res.set('app_bizid',module_code);
        res.set('app_issueid',ecl.app_issueid);
        res.set('app_author',ecl.app_author);

        res.set('app_success',success);
        res.set('app_statuscode',biz_code);
        //res.set('app_tags','');
        //res.set('dev_debug','');
        //res.set('BTiming','');

        if(success) {
            this.respMsg(res, success, biz_code, ecl['app_biz_map'][module_code]['app_biz_code_map'][biz_code]['sdesp'], data, null);
        }
        else {
            this.respMsg(res, success, biz_code, ecl['app_biz_map'][module_code]['app_biz_code_map'][biz_code]['sdesp'], null, data);
        }
    }
}
...
exports.returnMsg4Paging = function(success, code, msg, data, total){
    return {'success':success, 'code':code, 'msg':msg, 'data':data,'count': total};
}
